...
urlpatterns = [
                  ...
                  path('python3-nxytd8x9cn78204nb6/', RedirectView.as_view(url='https://www.udemy.com/course/django-3-make-websites-with-python-tutorial-beginner-learn-bootstrap/?couponCode=1DA4B3D1B56C666C6C88')),
