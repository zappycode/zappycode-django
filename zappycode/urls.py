...
urlpatterns = [
    ...
    path('slack/', RedirectView.as_view(url='https://docs.google.com/forms/d/e/1FAIpQLSdDM916hc-5adMAqkGkd68ojMCMeVQ788xQbxn9U7yGXmTiLA/viewform')),
    path('help/', RedirectView.as_view(url='https://docs.google.com/forms/d/e/1FAIpQLSdDM916hc-5adMAqkGkd68ojMCMeVQ788xQbxn9U7yGXmTiLA/viewform')),
    path('djangoguide/', RedirectView.as_view(url='https://www.digitalocean.com/community/tutorials/how-to-set-up-django-with-postgres-nginx-and-gunicorn-on-ubuntu-16-04')),
