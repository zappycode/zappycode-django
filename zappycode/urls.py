...
urlpatterns = [
                  ...
                  path('python3-nxytd8x9cn78204nb6/', RedirectView.as_view(url='https://www.udemy.com/course/django-3-make-websites-with-python-tutorial-beginner-learn-bootstrap/?couponCode=1B10A536F6D4807C9B0D')),
